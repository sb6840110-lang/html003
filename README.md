...
<body class="bg-slate-100 font-sans min-h-screen pb-12">
    ...
    <main class="max-w-5xl mx-auto mt-6 px-4 space-y-6">
        ...
        <!-- Teacher Only Area: Dashboard & Attendance Log -->
        <section id="teacherPanel" class="hidden space-y-6">
            <div class="bg-amber-50 border border-amber-200 p-4 rounded-2xl flex items-center justify-between text-amber-900">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-amber-500 text-white rounded-xl flex items-center justify-center font-bold text-lg">
                        <i class="fa-solid fa-user-shield"></i>
                    </div>
                    <div>
                        <h3 class="font-bold text-sm">ส่วนงานสำหรับครูเวร (Teacher Dashboard)</h3>
                        <p class="text-xs text-amber-700">คุณมีสิทธิ์เข้าถึงข้อมูลสรุปและประวัติการลงทะเบียนทั้งหมดในระบบ</p>
                    </div>
                </div>
                <span class="text-xs bg-amber-200 font-bold px-3 py-1 rounded-full border border-amber-300">สิทธิ์ผู้ดูแลระบบ</span>
            </div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md border border-slate-200">
                <h2 class="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2">
                    <i class="fa-solid fa-list-check text-indigo-600"></i> ประวัติการลงทะเบียนทั้งหมด
                </h2>
    ...
    <script>
        // State Management
        let currentUser = null; // { role: 'student' | 'teacher', name: string }
            ...
            tbody.innerHTML = attendanceData.map(item => {
                ...
                return `
                    <tr class="hover:bg-slate-50 transition">
                        ...
                        <td class="p-3">
                            <img src="${item.imgUrl}" class="w-10 h-10 rounded-lg object-cover border border-slate-200">
                        </td>
